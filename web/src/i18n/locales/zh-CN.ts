export default {
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", mode: "生成模式", modeReference: "全能参考", modeKeyframe: "首尾帧", modeHint: "无参考文件时自动按文生视频发送；全能参考可在提示词中用 <Picture 1>、<Audio 1> 指代素材", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    videoWorkbench: {
        ...
        firstFrame: "首帧",
        lastFrame: "尾帧",
        keyframeHint: "拖入或上传首帧 / 尾帧图片（最多 2 张，可只传首帧）",
        audioHint: "拖放或上传音频作为音画协同参考（最多 5 个），提示词中可用 <Audio 1> 指代",
        audioLimit: "参考音频最多 {{count}} 个",
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "暂无可复制的提示词", infoTitle: "查看节点信息", info: "信息", removeTitle: "移除节点", retryTitle: "重新生成", saveAsset: "存资产", downloadAudio: "下载音频", downloadVideo: "下载视频", downloadImage: "下载图片", editTextTitle: "编辑文本", editText: "编辑文字", decreaseFont: "减小字号", increaseFont: "增大字号", zoomOut: "缩小", zoomIn: "放大", uploadImage: "上传图片", replaceVideo: "替换视频", uploadVideo: "上传视频", replaceAudio: "替换音频", uploadAudio: "上传音频", captureFrame: "截取帧", firstFrame: "首帧", lastFrame: "尾帧", currentFrame: "当前帧", nodeInfo: "节点信息", name: "名称", type: "类型", size: "尺寸", position: "位置", status: "状态", imageGroup: "图片组", imageSize: "图片大小" },
