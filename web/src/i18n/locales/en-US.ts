export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", mode: "Generation mode", modeReference: "All-reference", modeKeyframe: "First & last frame", modeHint: "With no reference files it sends as text-to-video; in all-reference mode use <Picture 1>, <Audio 1> in the prompt to refer to media", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    videoWorkbench: {
        ...
        firstFrame: "First",
        lastFrame: "Last",
        keyframeHint: "Drag or upload first / last frame images (max 2; first frame alone is fine)",
        audioHint: "Drop or upload audio as a reference for audio-visual synergy (max 5); refer to it with <Audio 1> in the prompt",
        audioLimit: "At most {{count}} reference audio files",
